        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="hero-actions">
              <button className="btn btn-primary btn-lg">Join as Youth</button>
              <button className="btn btn-outline btn-lg">I'm an Employer</button>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>Skills-based matching connects youth with the right jobs, funding, and training opportunities.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">📄</div>
              <h3>Digital Profiles</h3>
              <p>Showcase your CV, education, skills, and portfolio all in one place.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">📊</div>
              <h3>Track Applications</h3>
              <p>Follow your application status in real-time with full transparency.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">💬</div>
              <h3>Direct Messaging</h3>
              <p>Connect directly with employers and investors through the platform.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">📈</div>
              <h3>Funding Access</h3>
              <p>Discover grants, loans, and equity opportunities tailored to your venture.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">🏆</div>
              <h3>Skill Recognition</h3>
              <p>List and validate your skills to stand out to the right opportunities.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="roles-grid">
            <div className="role-card role-youth">
              ...
              <h3>Youth</h3>
              <p>Create your profile, discover opportunities, apply to jobs, funding, and training. Build your future.</p>
              <ul>
            ...
            <div className="role-card role-investor">
              <div className="role-icon">📊</div>
              <h3>Investors</h3>
              <p>Discover and fund promising young talent. Post funding opportunities and track applicants.</p>
              <ul>
            ...
            <div className="role-card role-org">
              <div className="role-icon">🏢</div>
              <h3>Organizations</h3>
              <p>Find skilled youth for jobs and training programs. Post openings and build your talent pipeline.</p>
              <ul>
